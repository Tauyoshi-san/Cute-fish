...
const bgm=new Audio(assetUrl('assets/sound/spo_ge_suityu02.mp3'));
bgm.loop=true;
...
const sampleUrls:Partial<Record<Sfx,string>>={feedToss:assetUrl('assets/sound/sfx/feed-toss.wav'),eatMunch:assetUrl('assets/sound/sfx/eat-munch.wav'),buySuccess:assetUrl('assets/sound/sfx/buy-success.wav'),fail:assetUrl('assets/sound/sfx/action-fail.wav'),cleanSwish:assetUrl('assets/sound/sfx/clean-swish.wav'),missionStep:assetUrl('assets/sound/sfx/mission-step.wav'),missionComplete:assetUrl('assets/sound/sfx/mission-complete.wav'),fishArrive:assetUrl('assets/sound/sfx/fish-arrive.wav'),evolveStart:assetUrl('assets/sound/sfx/evolve-start.wav'),evolveComplete:assetUrl('assets/sound/sfx/evolve-complete.wav')};
